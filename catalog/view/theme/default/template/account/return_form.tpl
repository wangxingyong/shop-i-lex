...
<div id="content"><?php echo $content_top; ?>
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="return">
    <h2><?php echo $text_order; ?></h2>
      <table class="form">
          <tr>
              <td  style="width: 170px"><span class="required">*</span> <?php echo $entry_firstname; ?></td>
              <td>
          ...
          <tr>
              <td><span class="required">*</span> <h2><?php echo $text_product; ?></h2></td>
              <td>
          ...
          <tr>
              <td><span class="required">*</span> <?php echo $text_additional; ?></td>
              <td>
          ...
          <tr>
              ...
              <td>
                  ...
                  <div class="right"><a onclick="$('#return').submit();" class="button highlight"><span><?php echo $button_confirm; ?></span></a></div>
                      </div>
              </td>
          </tr>
      </table>
